      ...
      <div className="mx-auto grid w-full max-w-[1360px] items-center gap-16 lg:grid-cols-[0.42fr_0.58fr] lg:gap-24 xl:gap-28">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <div className="animate-hero-scale-in animation-delay-300 mt-9 flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
            ...
            <a
              href="#como-funciona"
              className="animate-hero-fade-up animation-delay-400 inline-flex w-full items-center justify-center gap-2 rounded-full border border-slate-200/80 bg-white px-7 py-3.5 text-[0.95rem] font-semibold tracking-[-0.01em] text-foreground shadow-[0_1px_2px_rgba(15,23,42,0.035)] transition-all duration-300 ease-out hover:-translate-y-[1px] hover:border-slate-300 hover:shadow-[0_10px_22px_-12px_rgba(15,23,42,0.16)] sm:w-auto"
            >
              Ver cómo funciona
            </a>
          </div>
